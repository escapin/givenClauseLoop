%--------------------------------------------------------------------------
% File     : PUZ001-2 : TPTP v5.3.0. Released v1.0.0.
% Domain   : Puzzles
...
% Rating   : 0.05 v5.3.0, 0.11 v5.2.0, 0.00 v5.1.0, 0.06 v5.0.0, 0.07 v4.1.0, 0.08 v4.0.1, 0.09 v3.7.0, 0.00 v3.4.0, 0.08 v3.3.0, 0.21 v3.2.0, 0.15 v3.1.0, 0.18 v2.7.0, 0.17 v2.6.0, 0.10 v2.5.0, 0.17 v2.4.0, 0.00 v2.3.0, 0.11 v2.2.1, 0.11 v2.2.0, 0.11 v2.1.0, 0.00 v2.0.0
...
cnf(noone_else_lives_at_mansion,axiom,
    ...
    | $equality(Person,aunt_agatha)
    | $equality(Person,butler)
    | $equality(Person, charles) )).
