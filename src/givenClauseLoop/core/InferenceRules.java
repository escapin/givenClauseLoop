...
public class InferenceRules {
	 ...
	 */
	public static Set<Clause> factorisation(Clause c){
		Set<Clause> factors= new HashSet<Clause>();
		Map<Variable, Term> sigma;
		for(Literal l1: c.getLiterals())
			for(Literal l2: c.getLitMap().get(l1.sign()? "": "~" + l1.getSymbol())){
	 ...
	 */
	public static Set<Clause> binaryResolution(Clause c1, Clause c2){
